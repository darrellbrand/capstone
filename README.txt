...
mainscreen.html line 85 added a button that will decrement the guitar inventory by one on and display success message on success or show fail message on failure.
...
EnufPartsValidator.java line 36 added conditional to check if creating a guitar will decrement the guitarPart inventory below the minimum.
ValidEnufParts.java line 20 I enhanced the error message to "There aren't enough guitarParts in inventory! Check the minimum inventory values".
